...
proc_cols = [col for col in df_spark.columns if col not in ['PAT_ID', 'END_DTTM', 'FUTURE_CRC_EVENT', 'SPLIT']]
...
# Step 2: Calculate Risk Ratios for Binary Procedure Features (TRAIN DATA ONLY)
...
sample_fraction = min(200000 / total_train_rows, 1.0)
