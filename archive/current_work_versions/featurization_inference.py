...
# -----------------------------------------------------------------------------
DENIAL_PDF_PATH = "/Workspace/Repos/mijo8881@mercy.net/fudgesicle/utils/sample_denial_letters/@Sprg 08.30.23 Anthem Cot RL PNC.pdf"
...
display(spark.sql(f"select * from {DIAGNOSIS_TABLE}))
