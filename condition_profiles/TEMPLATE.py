...
# Defaults to empty string (no examples shown) if not set.
DIAGNOSIS_EXAMPLES = ""  # e.g., 'For example:\n- "Acute respiratory failure with hypoxia"\n'

# Custom system message for structured data extraction.
# Defaults to "You are a clinical data analyst." if not set.
